...
for(let i = 0; i < 1; i++) {
	...
	for(let j = 0; j < 10; j++) {
		arrTemp.push([j, Math.random() * num]);
	}
	arrORG.push(arrTemp);
}

let data = {"subtitle": "Demo Chart", "description": "description", "series_list": arrORG};
let formData = {'tile': "line_chart", 'key': "demoChart1", 'data': JSON.stringify(data)};
postRequestToTipboard(formData);
...
data = {"subtitle": "Demo Chart", "description": "description", "series_list": arrORG};
formData = {'tile': "line_chart", 'key': "demoChart2", 'data': JSON.stringify(data)};
postRequestToTipboard(formData);
/*******************************************************************/
arrORG = [];
...
data = {"subtitle": "Demo Chart", "description": "description", "series_list": arrORG};
formData = {'tile': "line_chart", 'key': "demoChart3", 'data': JSON.stringify(data)};
postRequestToTipboard(formData);
/*******************************************************************/
arrORG = [];
...
data = {"subtitle": "Demo Chart", "description": "description", "series_list": arrORG};
formData = {'tile': "line_chart", 'key': "demoChart4", 'data': JSON.stringify(data)};
postRequestToTipboard(formData);